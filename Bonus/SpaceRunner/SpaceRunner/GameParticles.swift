...
class GameParticles {
    ...
    // MARK: Class Enum
    enum Particles:Int {
        case background, engine, bonus, shield, star
    }
    
    // MARK: - Private class variables
    private var backgroundEmitter = SKEmitterNode()
    private var engineEmitter = SKEmitterNode()
    private var bonusEmitter = SKEmitterNode(fileNamed: "Bonus.sks")
    private var shieldEmitter = SKEmitterNode(fileNamed: "Shield.sks")
    private var starEmitter = SKEmitterNode(fileNamed: "Star.sks")
    ...
    private func setupEngineEmitter() {
        ...
        // Birthrate and Lifetime
        engineEmitter.particleBirthRate = 6.0
        ...
        // Speed
        engineEmitter.particleSpeed = -40.0
    ...
    func createParticles(particles: Particles) -> SKEmitterNode {
        ...
        case .bonus:
            return bonusEmitter!.copy() as! SKEmitterNode
            
        case .shield:
            return shieldEmitter!.copy() as! SKEmitterNode
            
        case .star:
            return starEmitter!.copy() as! SKEmitterNode
        }
    }
}
