...
class Shield: SKSpriteNode {
    ...
    private let emitter = GameParticles.sharedInstance.createParticles(particles: .shield)
    ...
    convenience init() {
        let texture = GameTextures.sharedInstance.texture(name: SpriteName.shield)
    ...
    private func setupPhysics() {
        ...
        self.physicsBody?.categoryBitMask = Contact.shield
